...
networkMessagesSystem.OnBannedFromServer = function(self, _ip, _port)
...
networkMessagesSystem.OnKickedFromServer = function(self, _ip, _port)
...
networkMessagesSystem.OnRemotePlayerBanned = function(self, _ip, _port)
...
networkMessagesSystem.OnRemotePlayerDisconnected = function(self, _ip, _port)
	print("[Client] Remote player disconnected")
end
networkMessagesSystem.OnRemotePlayerKicked = function(self, _ip, _port)
