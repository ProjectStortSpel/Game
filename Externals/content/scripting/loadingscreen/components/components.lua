...
-- Position Component
local LoadingTextComponent = ComponentType()
LoadingTextComponent.Name = "LoadingText"
LoadingTextComponent.TableType = TableType.Array
LoadingTextComponent:AddVariable("Text", ByteSize.String)
worldCreator:AddComponentType(LoadingTextComponent)
