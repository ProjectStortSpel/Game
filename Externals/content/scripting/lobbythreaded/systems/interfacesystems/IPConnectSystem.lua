...
IPConnectSystem.UpdateText = function(self)
	...
	world:GetComponent(id, "Position", 0):SetFloat3(-0.57, 0.22, -2.0)
	world:GetComponent(id, "Scale", 0):SetFloat3(2.0, 0.1, 1.0)
	world:GetComponent(id, "Rotation", 0):SetFloat3(0.0, 0.0, 0.0)
	world:GetComponent(id, "TextTexture", "Name"):SetString("IPConnectText")
	world:GetComponent(id, "TextTexture", "Text"):SetString(textInput .. "_")
...
IPConnectSystem.CreateBackground = function(self)
	...
	world:GetComponent(id, "Rotation", 0):SetFloat3(0.0, 0.0, 0.0)
	world:GetComponent(id, "TextTexture", "Name"):SetString("IPConnectBackgroundConnectText")
	world:GetComponent(id, "TextTexture", "Text"):SetString("Connect via IP")
	world:GetComponent(id, "TextTexture", "FontIndex"):SetInt(0)
	...
	world:GetComponent(id, "Rotation", 0):SetFloat3(0.0, 0.0, 0.0)
	world:GetComponent(id, "TextTexture", "Name"):SetString("IPConnectBackgroundExampleText")
	world:GetComponent(id, "TextTexture", "Text"):SetString("ex. 127.0.0.1:6112")
	world:GetComponent(id, "TextTexture", "FontIndex"):SetInt(0)
	world:GetComponent(id, "TextTexture", "R"):SetFloat(0.306)
	world:GetComponent(id, "TextTexture", "G"):SetFloat(0.224)
	world:GetComponent(id, "TextTexture", "B"):SetFloat(0.157)
