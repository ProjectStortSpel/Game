...
FlowingWaterSystem.EntitiesAdded = function(self, dt, entities)
	...
	for i = 1, #entities do
		...
		--if modelname == "riverstraight" then
		...
		--elseif modelname == "rivercorner" then
		--	world:SetComponent(newFlowingTile, "Model", "ModelName", "watercorner");
		--	world:SetComponent(newFlowingTile, "Model", "ModelPath", "watercorner");
		...
		if ix == 1 then
			world:GetComponent(newFlowingTile, "Rotation", "X"):SetFloat3(0, -math.pi/2, 0)
		elseif iy == 1 then
			world:GetComponent(newFlowingTile, "Rotation", "X"):SetFloat3(0, -iy*math.pi, 0)
		elseif iy == -1 then
