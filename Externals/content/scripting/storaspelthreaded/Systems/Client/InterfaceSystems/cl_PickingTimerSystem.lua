...
PickingTimerSystem.PostInitialize = function(self)
	...
	world:GetComponent(id, "Position", 0):SetFloat3(-endPosition, 2.0, -3.9999)
...
PickingTimerSystem.AlignBar = function(self)
	...
	world:GetComponent(self.RightEndEntity, "Position", 0):SetFloat3(Transform.RightEndPosition, 2.0, -3.9999)
end
...
PickingTimerSystem.SpawnWood = function(self)
	...
	world:GetComponent(sideEntity, "Position", 0):SetFloat3(Transform.PositionX, 2.0, -3.999)
	...
	world:GetComponent(sideEntity, "LerpPosition", "Time"):SetFloat4(0.5, Transform.PositionX, 1.0 + 0.3 * (math.random() * 2.0 - 1), -3.999)
