...
CreateMapSystem.AddTile = function(self, posX, posZ, tiletype)
	...
	elseif tiletype == 115 then -- 115 = s = Available spawn point
		...
		--world:GetComponent(mapEntity, "MapSpecs", "NoOfSpawnpoints"):SetInt(0)
		--local noOfSpawnpoints = world:GetComponent(mapEntity, "MapSpecs", "NoOfSpawnpoints"):GetInt(0)
		...
		local noOfSpawnpoints = world:GetComponent(mapSpecsEntity[1], "MapSpecs", "NoOfSpawnpoints"):GetInt(0)
		local noOfSpawnpoints = world:GetComponent(mapEntity, "MapSpecs", "NoOfSpawnpoints"):GetInt(0)
		print("haj1", noOfSpawnpoints)
		noOfSpawnpoints = noOfSpawnpoints + 1
		print("haj2", noOfSpawnpoints)
		world:GetComponent(mapSpecsEntity[1], "MapSpecs", "NoOfSpawnpoints"):SetInt(noOfSpawnpoints)
...
CreateMapSystem.CreateMap = function(self, name)
	...
	-- Set size of the map.
	world:GetComponent(mapEntity, "MapSpecs", "SizeX"):SetInt2(self.mapX, self.mapY)
