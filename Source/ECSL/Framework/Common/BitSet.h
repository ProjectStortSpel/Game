...
namespace ECSL
{
	namespace BitSet
	{
		...
		bool BitSetPassFilters(unsigned int _bitSetCount, const BitSet::DataType* _bitSet, const BitSet::DataType* _mandatoryMask, const BitSet::DataType* _oneOfMask, const BitSet::DataType* _exclusionMask);
