...
RENDERER_SRC_FILES := $(shell for /F "tokens=*" %%A in ('dir /s /b %CD%\..\..\..\..\Source\Renderer\*.cpp') do @echo %%~dpnxA)
...
RENDERER_SRC_FILES := $(shell find $(LOCAL_PATH)/../../../../Source/Renderer/ -name "*.cpp" -type f -printf "%P \n")
RENDERER_SRC_FILES := $(addprefix ../../../../Source/Renderer/, $(RENDERER_SRC_FILES))
